    ...
    <AbsoluteFill style={{ backgroundColor: bgColor }}>
      ...
      >
        ...
        {dek && (dek.heading || dek.text) && (
          <p style={{ ...styles.dek, ...(isLandscape ? {} : { maxWidth: '100%' }), ...(accentColor ? { borderLeftColor: accentColor } : {}), opacity: dekOpacity }}>
        ...
        {rest.length > 0 && (
          <>
            <div style={{ ...styles.rule, ...(isLandscape ? {} : { maxWidth: '100%' }), transform: `scaleX(${ruleScale})`, transformOrigin: 'left center' }} />
            <div style={isLandscape ? styles.list : { ...styles.list, maxWidth: '100%' }}>
              {rest.map((item, index) => {
