...
const Content005 = React.memo(({ scene }) => {
  ...
  // The two-column split squeezes hard on a narrow portrait/square canvas -
  // stack the columns instead of shrinking the whole 1920-wide row to fit.
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: bgColor }}>
      ...
      >
        ...
        <div style={isLandscape ? styles.columns : { ...styles.columns, flexDirection: 'column', gap: spacing.lg }}>
