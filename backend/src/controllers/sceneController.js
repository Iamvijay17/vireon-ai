...
const STANDARDIZED_ITEMS_TEMPLATE_IDS = ['001-content', '002-content', '003-content', '004-content', '005-content', '006-content', '007-content', '008-content', '009-content', '010-content', '011-content', '012-content', '013-content', '014-content', '015-content', '016-content', '019-content', '020-content'];
...
class SceneController {
  ...
  static async remapElementsForTemplate(req, res, next) {
    try {
      ...
      const isItemsShaped = (id) => STANDARDIZED_ITEMS_TEMPLATE_IDS.includes(id);

      const bothStandardized =
        isItemsShaped(templateId) &&
        isItemsShaped(fromTemplateId);
